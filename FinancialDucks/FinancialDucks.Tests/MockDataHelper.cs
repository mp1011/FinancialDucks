...
namespace FinancialDucks.Tests
{
    public class MockDataHelper
    {
        ...
        public List<IBudgetLine> MockBudgetLines { get; } = new List<IBudgetLine>();
        ...
        public IEnumerable<ITransaction> AddFastFoodTransactionsSinceOneYear()
        {
            List<ITransactionDetail> transactionDetails = new List<ITransactionDetail>();
            ...
            string selector = "", bool waitForNavigate = false)
        {
            return new ScraperCommandEdit
            {
                ...
                Selector = selector,
                PauseBeforeStep = waitForNavigate
            };
        }
    }
}
